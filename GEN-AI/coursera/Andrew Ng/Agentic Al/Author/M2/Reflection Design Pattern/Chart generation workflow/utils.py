...
# The OpenAI client reads its key from env (routed through the DLAI proxy by usercustomize.py).
openai_client = OpenAI(api_key=openai_api_key) if openai_api_key else OpenAI()


def get_response(model: str, prompt: str) -> str:
    """Call an OpenAI model (gpt-4o-mini, gpt-4o, gpt-4.1, o4-mini, ...) and return its text."""
